...
const vec3 VIEW_PORT = vec3(1.0, 1.0, 1.0);
...
const Sphere spheres[NUM_SPHERES] = Sphere[](
    Sphere(vec3(0.0, -1.0, 3.0), 1.0, vec3(1.0, 0.0, 0.0)), // Red sphere
    Sphere(vec3(2.0, 0.0, 4.0), 1.0, vec3(0.0, 0.0, 1.0)),  // Blue sphere
    Sphere(vec3(-2.0, 0.0, 4.0), 1.0, vec3(0.0, 1.0, 0.0)) // Green sphere
);
